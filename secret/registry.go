...
// Load parses a secret identifier and returns a Provider and the secret name.
...
// Example:
//
//	provider, secretName, err := secret.Load(ctx, "arn:aws:secretsmanager:us-east-1:123456789012:secret:mykey")
//	if err != nil {
//		return err
//	}
//	signer := secret.NewHMAC256(provider, secretName)
func Load(ctx context.Context, secretID string) (Provider, string, error) {
